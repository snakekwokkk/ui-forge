...
Capture semantic colors, type style and fallback, spacing scale, grids, component density, radii, borders, shadows, surfaces, photography, illustration, 3D, icons, motion evidence, traits, usage rules, and exclusions. Do not claim an exact font from appearance alone.
